...
define i32 @main() {
	...
	%t2 = getelementptr [1 x i8*], [1 x i8*]* @.TV_vtable, i32 0 , i32 0
	store i8** %t2, i8*** %t1
	; sto message send: AllocationExpressionTV.Start
	%t3 = bitcast i8* %t0 to i8***
	%t4 = load i8**, i8*** %t3
	 ; to className einai: TV
...
define i32 @TV.Start(i8* %this) {
	...
	%t1 = bitcast i8* %t0 to i8***
	%t2 = getelementptr [21 x i8*], [21 x i8*]* @.Tree_vtable, i32 0 , i32 0
	store i8** %t2, i8*** %t1
	store i8* %t0, i8** %root
	...
	%t26 = load i8**, i8*** %t25
	 ; to className einai: Tree
	%t27 = getelementptr i8*, i8** %t26, i32 12
	%t28 = load i8*, i8** %t27
	%t29 = bitcast i8* %t28 to i1 (i8*,i32)*
	%t30 = call i1 %t29(i8* %t24, i32 24)
	; Sto Assignment Statement 
	store i1 %t30, i1* %ntb
	; sto message send: root.Insert
	; edw mpainei to psaximo tou l
	...
	%t68 = load i8**, i8*** %t67
	 ; to className einai: Tree
	%t69 = getelementptr i8*, i8** %t68, i32 18
	%t70 = load i8*, i8** %t69
	%t71 = bitcast i8* %t70 to i1 (i8*)*
	%t72 = call i1 %t71(i8* %t66)
	; Sto Assignment Statement 
	store i1 %t72, i1* %ntb
	call void (i32) @print_int(i32 100000000)
	%t73 = call i8* @calloc(i32 1, i32 24)
	%t74 = bitcast i8* %t73 to i8***
	%t75 = getelementptr [1 x i8*], [1 x i8*]* @.MyVisitor_vtable, i32 0 , i32 0
	store i8** %t75, i8*** %t74
	store i8* %t73, i8** %v

	call void (i32) @print_int(i32 50000000)
	; sto message send: root.accept
	; edw mpainei to psaximo tou l
	%t76 = load i8*, i8** %root
	%t77 = bitcast i8* %t76 to i8***
	%t78 = load i8**, i8*** %t77
	 ; to className einai: Tree
	%t79 = getelementptr i8*, i8** %t78, i32 20
	%t80 = load i8*, i8** %t79
	%t81 = bitcast i8* %t80 to i32 (i8*,i8*)*
	;eimai sta orismata 
	%t82 = load i8*, i8** %v
	%t83 = call i32 %t81(i8* %t76, i8* %t82)
	; Sto Assignment Statement 
	store i32 %t83, i32* %nti
	call void (i32) @print_int(i32 100000000)
	...
	%t86 = load i8**, i8*** %t85
	 ; to className einai: Tree
	%t87 = getelementptr i8*, i8** %t86, i32 17
	%t88 = load i8*, i8** %t87
	%t89 = bitcast i8* %t88 to i32 (i8*,i32)*
	%t90 = call i32 %t89(i8* %t84, i32 24)
	call void (i32) @print_int(i32 %t90)
	; sto message send: root.Search
	; edw mpainei to psaximo tou l
	%t91 = load i8*, i8** %root
	...
	%t93 = load i8**, i8*** %t92
	 ; to className einai: Tree
	%t94 = getelementptr i8*, i8** %t93, i32 17
	%t95 = load i8*, i8** %t94
	%t96 = bitcast i8* %t95 to i32 (i8*,i32)*
	%t97 = call i32 %t96(i8* %t91, i32 12)
	call void (i32) @print_int(i32 %t97)
	; sto message send: root.Search
	; edw mpainei to psaximo tou l
	%t98 = load i8*, i8** %root
	...
	%t100 = load i8**, i8*** %t99
	 ; to className einai: Tree
	%t101 = getelementptr i8*, i8** %t100, i32 17
	%t102 = load i8*, i8** %t101
	%t103 = bitcast i8* %t102 to i32 (i8*,i32)*
	%t104 = call i32 %t103(i8* %t98, i32 16)
	call void (i32) @print_int(i32 %t104)
	; sto message send: root.Search
	; edw mpainei to psaximo tou l
	%t105 = load i8*, i8** %root
	%t106 = bitcast i8* %t105 to i8***
	%t107 = load i8**, i8*** %t106
	 ; to className einai: Tree
	%t108 = getelementptr i8*, i8** %t107, i32 17
	%t109 = load i8*, i8** %t108
	%t110 = bitcast i8* %t109 to i32 (i8*,i32)*
	%t111 = call i32 %t110(i8* %t105, i32 50)
	call void (i32) @print_int(i32 %t111)
	; sto message send: root.Search
	; edw mpainei to psaximo tou l
	%t112 = load i8*, i8** %root
	%t113 = bitcast i8* %t112 to i8***
	%t114 = load i8**, i8*** %t113
	 ; to className einai: Tree
	%t115 = getelementptr i8*, i8** %t114, i32 17
	%t116 = load i8*, i8** %t115
	%t117 = bitcast i8* %t116 to i32 (i8*,i32)*
	%t118 = call i32 %t117(i8* %t112, i32 12)
	call void (i32) @print_int(i32 %t118)
	; sto message send: root.Delete
	; edw mpainei to psaximo tou l
	%t119 = load i8*, i8** %root
	%t120 = bitcast i8* %t119 to i8***
	%t121 = load i8**, i8*** %t120
	 ; to className einai: Tree
	%t122 = getelementptr i8*, i8** %t121, i32 13
	%t123 = load i8*, i8** %t122
	%t124 = bitcast i8* %t123 to i1 (i8*,i32)*
	%t125 = call i1 %t124(i8* %t119, i32 12)
	; Sto Assignment Statement 
	store i1 %t125, i1* %ntb
	; sto message send: root.Print
	; edw mpainei to psaximo tou l
	%t126 = load i8*, i8** %root
	%t127 = bitcast i8* %t126 to i8***
	%t128 = load i8**, i8*** %t127
	 ; to className einai: Tree
	%t129 = getelementptr i8*, i8** %t128, i32 18
	%t130 = load i8*, i8** %t129
	%t131 = bitcast i8* %t130 to i1 (i8*)*
	%t132 = call i1 %t131(i8* %t126)
	; Sto Assignment Statement 
	store i1 %t132, i1* %ntb
	; sto message send: root.Search
	; edw mpainei to psaximo tou l
	%t133 = load i8*, i8** %root
	%t134 = bitcast i8* %t133 to i8***
	%t135 = load i8**, i8*** %t134
	 ; to className einai: Tree
	%t136 = getelementptr i8*, i8** %t135, i32 17
	%t137 = load i8*, i8** %t136
	%t138 = bitcast i8* %t137 to i32 (i8*,i32)*
	%t139 = call i32 %t138(i8* %t133, i32 12)
	call void (i32) @print_int(i32 %t139)
...
define i32 @Tree.accept(i8* %this, i8* %.v) {
	...
	; sto message send: v.visit
	; edw mpainei to psaximo tou l
	%t0 = load i8*, i8** %v
	%t1 = bitcast i8* %t0 to i8***
	%t2 = load i8**, i8*** %t1
	 ; to className einai: Visitor
	%t3 = getelementptr i8*, i8** %t2, i32 0
	%t4 = load i8*, i8** %t3
	%t5 = bitcast i8* %t4 to i32 (i8*,i8*)*
	%t6 = call i32 %t5(i8* %t0, i8* %this)
	; Sto Assignment Statement 
	store i32 %t6, i32* %nti
...
define i32 @Visitor.visit(i8* %this, i8* %.n) {
	...
	store i8* %.n, i8** %n
	%nti = alloca i32
	; sto message send: n.GetHas_Right
	; edw mpainei to psaximo tou l
	%t0 = load i8*, i8** %n
	%t1 = bitcast i8* %t0 to i8***
	%t2 = load i8**, i8*** %t1
	...
	if_then_0:
	; sto message send: n.GetRight
	; edw mpainei to psaximo tou l
	%t7 = load i8*, i8** %n
	%t8 = bitcast i8* %t7 to i8***
	%t9 = load i8**, i8*** %t8
	 ; to className einai: Tree
	%t10 = getelementptr i8*, i8** %t9, i32 3
	%t11 = load i8*, i8** %t10
	%t12 = bitcast i8* %t11 to i8* (i8*)*
	%t13 = call i8* %t12(i8* %t7)
	; Sto Assignment Statement 
	%t14 =  getelementptr i8, i8* %this, i32 16
	%t15 = bitcast i8* %t14 to i8**
	store i8* %t13, i8** %t15

	; sto message send: r.accept
	; edw mpainei to psaximo tou l
	%t16 = getelementptr i8, i8* %this, i32 16
	%t17 = bitcast i8* %t16 to i8**
	%t18 = load i8*, i8** %t17
	%t19 = bitcast i8* %t18 to i8***
	%t20 = load i8**, i8*** %t19
	 ; to className einai: Tree
	%t21 = getelementptr i8*, i8** %t20, i32 20
	%t22 = load i8*, i8** %t21
	%t23 = bitcast i8* %t22 to i32 (i8*,i8*)*
	%t24 = call i32 %t23(i8* %t18, i8* %this)
	; Sto Assignment Statement 
	store i32 %t24, i32* %nti
	br label %if_end_0
	...
	if_end_0:
	; sto message send: n.GetHas_Left
	; edw mpainei to psaximo tou l
	%t25 = load i8*, i8** %n
	%t26 = bitcast i8* %t25 to i8***
	%t27 = load i8**, i8*** %t26
	 ; to className einai: Tree
	%t28 = getelementptr i8*, i8** %t27, i32 8
	%t29 = load i8*, i8** %t28
	%t30 = bitcast i8* %t29 to i1 (i8*)*
	%t31 = call i1 %t30(i8* %t25)
	; stin arxh tou IfStatement
	br i1 %t31, label %if_then_1, label %if_else_1

	if_then_1:
	; sto message send: n.GetLeft
	; edw mpainei to psaximo tou l
	%t32 = load i8*, i8** %n
	%t33 = bitcast i8* %t32 to i8***
	%t34 = load i8**, i8*** %t33
	 ; to className einai: Tree
	%t35 = getelementptr i8*, i8** %t34, i32 4
	%t36 = load i8*, i8** %t35
	%t37 = bitcast i8* %t36 to i8* (i8*)*
	%t38 = call i8* %t37(i8* %t32)
	; Sto Assignment Statement 
	%t39 =  getelementptr i8, i8* %this, i32 8
	%t40 = bitcast i8* %t39 to i8**
	store i8* %t38, i8** %t40

	; sto message send: l.accept
	; edw mpainei to psaximo tou l
	%t41 = getelementptr i8, i8* %this, i32 8
	%t42 = bitcast i8* %t41 to i8**
	%t43 = load i8*, i8** %t42
	%t44 = bitcast i8* %t43 to i8***
	%t45 = load i8**, i8*** %t44
	 ; to className einai: Tree
	%t46 = getelementptr i8*, i8** %t45, i32 20
	%t47 = load i8*, i8** %t46
	%t48 = bitcast i8* %t47 to i32 (i8*,i8*)*
	%t49 = call i32 %t48(i8* %t43, i8* %this)
	; Sto Assignment Statement 
	store i32 %t49, i32* %nti
	br label %if_end_1
...
define i32 @MyVisitor.visit(i8* %this, i8* %.n) {
	...
	if_end_0:
	; sto message send: n.GetKey
	; edw mpainei to psaximo tou l
	%t25 = load i8*, i8** %n
	%t26 = bitcast i8* %t25 to i8***
	%t27 = load i8**, i8*** %t26
	 ; to className einai: Tree
	%t28 = getelementptr i8*, i8** %t27, i32 5
	%t29 = load i8*, i8** %t28
	%t30 = bitcast i8* %t29 to i32 (i8*)*
	%t31 = call i32 %t30(i8* %t25)
	call void (i32) @print_int(i32 %t31)
	; sto message send: n.GetHas_Left
	; edw mpainei to psaximo tou l
	%t32 = load i8*, i8** %n
	%t33 = bitcast i8* %t32 to i8***
	%t34 = load i8**, i8*** %t33
	 ; to className einai: Tree
	%t35 = getelementptr i8*, i8** %t34, i32 8
	%t36 = load i8*, i8** %t35
	%t37 = bitcast i8* %t36 to i1 (i8*)*
	%t38 = call i1 %t37(i8* %t32)
	; stin arxh tou IfStatement
	br i1 %t38, label %if_then_1, label %if_else_1
	...
	%t41 = load i8**, i8*** %t40
	 ; to className einai: Tree
	%t42 = getelementptr i8*, i8** %t41, i32 4
	%t43 = load i8*, i8** %t42
	%t44 = bitcast i8* %t43 to i8* (i8*)*
	%t45 = call i8* %t44(i8* %t39)
	; Sto Assignment Statement 
	%t46 =  getelementptr i8, i8* %this, i32 8
	%t47 = bitcast i8* %t46 to i8**
	store i8* %t45, i8** %t47

	; sto message send: l.accept
	; edw mpainei to psaximo tou l
	%t48 = getelementptr i8, i8* %this, i32 8
	%t49 = bitcast i8* %t48 to i8**
	%t50 = load i8*, i8** %t49
	%t51 = bitcast i8* %t50 to i8***
	%t52 = load i8**, i8*** %t51
	 ; to className einai: Tree
	%t53 = getelementptr i8*, i8** %t52, i32 20
	%t54 = load i8*, i8** %t53
	%t55 = bitcast i8* %t54 to i32 (i8*,i8*)*
	%t56 = call i32 %t55(i8* %t50, i8* %this)
	; Sto Assignment Statement 
	store i32 %t56, i32* %nti
	br label %if_end_1
